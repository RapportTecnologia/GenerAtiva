...
WEBUI_NAME = os.environ.get("WEBUI_NAME", "Rapport Generativa")
if WEBUI_NAME != "Rapport Generativa":
    WEBUI_NAME += " (Rapport Generativa)"

WEBUI_FAVICON_URL = "https://generativa.rapport.tec.br/favicon.png"
